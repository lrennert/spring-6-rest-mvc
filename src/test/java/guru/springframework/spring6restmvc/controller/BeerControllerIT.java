...
class BeerControllerIT {
    ...
    void testCreateBeerMVC() throws Exception {
        ...
        assertThat(applicationEvents.stream(BeerCreatedEvent.class)).hasSize(1);
    }
    ...
    void testUpdateBeerBadVersion() throws Exception {
        ...
        System.out.println("Result 1: " + result.getResponse().getStatus());
        ...
        System.out.println("Result 2: " + result2.getResponse().getStatus());
    }
    ...
    void testPatchBeer() throws Exception {
        ...
        assertThat(applicationEvents.stream(BeerPatchedEvent.class)).hasSize(1);
    }
    ...
    void testPatchBeerBadName() throws Exception {
        ...
        assertThat(applicationEvents.stream(BeerPatchedEvent.class)).isEmpty();
    }
